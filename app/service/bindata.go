...
func assets_style_css() (*asset, error) {
	...
	info := bindata_file_info{name: "assets/style.css", size: 11487, mode: os.FileMode(420), modTime: time.Unix(1433618681, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
...
func assets_wrap_html() (*asset, error) {
	...
	info := bindata_file_info{name: "assets/wrap.html", size: 2301, mode: os.FileMode(420), modTime: time.Unix(1433619877, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
